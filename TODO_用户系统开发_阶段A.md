...
#### - [ ] 任务A.1：创建auth-schema.prisma并设计User和UserGongBiWork表结构
...
- [ ] 更新.gitignore，确保auth.db不被跟踪
  ```bash
  # 在.gitignore中添加：
  lugarden_universal/application/data/auth.db
  lugarden_universal/application/data/auth.db-journal
  lugarden_universal/application/generated/auth-prisma/
  ```

- [ ] 将本TODO移动到 `documentation/changelog/2025-11-03_用户系统开发_阶段A/TODO.md`
