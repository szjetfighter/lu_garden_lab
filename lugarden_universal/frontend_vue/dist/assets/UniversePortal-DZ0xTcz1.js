import { A as defineComponent, B as onMounted, C as onUnmounted, D as openBlock, E as renderList, G as resolveComponent, J as withCtx, L as reactive, M as ref, N as unref, O as normalizeClass, Q as toDisplayString, e as getUserFriendlyErrorMessage, f as isApiError, h as useRouter, i as __plugin_vue_export_helper_default, j as defineStore, k as Transition, p as withModifiers, q as Fragment, s as computed, t as createBaseVNode, u as createBlock, v as createCommentVNode, w as createElementBlock, y as createTextVNode, z as createVNode } from "./index-I6Qyf-Z2.js";
import { f as getUserInfo, g as isAuthenticated } from "./authApi-D2-rqmYK.js";
import "./BackButton-DY9fgpXO.js";
import "./ExclamationTriangleIcon-DPnftkPl.js";
import { b as ErrorState_default } from "./ErrorState-BqKb-ZOn.js";
import { b as EmptyState_default } from "./EmptyState-DVKoddbK.js";
import { b as LoadingSpinner_default } from "./LoadingSpinner-CngjKRiQ.js";
import { b as NotificationToast_default, c as AnimationWrapper_default } from "./components-CiBAdt-M.js";
import "./ProgressBar-C6Op2Wkm.js";
import { b as getApiServices } from "./enhancedApi-C4NCKSlP.js";
	...
	setup(__props) {
		...
		const loadUserInfo = async () => {
			try {
				...
				if (response.success && response.user) username.value = response.user.username;
				else username.value = "用户";
			} catch (error$1) {
				console.error("加载用户信息失败:", error$1);
				username.value = "用户";
			}
		};
...
var UniversePortal_default = /* @__PURE__ */ __plugin_vue_export_helper_default(UniversePortal_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-7083068d"]]);
