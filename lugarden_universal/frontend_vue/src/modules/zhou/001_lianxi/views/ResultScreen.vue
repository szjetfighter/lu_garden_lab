...
import PoemViewer from '@/modules/zhou/001_lianxi/components/PoemViewer.vue'
import ControlButtons from '@/modules/zhou/001_lianxi/components/ControlButtons.vue'
import InterpretationDisplay from '@/modules/zhou/001_lianxi/components/InterpretationDisplay.vue'
